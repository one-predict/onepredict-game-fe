...
export default class CanvasCollectableDrawer implements CollectableDrawer {
  ...
  public draw(collectable: Collectable, currentGameTime: number): void {
    ...
    this.ctx.drawImage(image, imageX, imageY, collectableRadius, collectableRadius);
    ...
    this.ctx.arc(x, y, collectableRadius / 2, -Math.PI / 2, -Math.PI / 2 + Math.PI * 2 * passed);
