import { GridDrawer } from '@tap-video-game/drawing/base/GridDrawer';
...
export default class CanvasGridDrawer implements GridDrawer {
  ...
  public draw(
    ...
    for (const bannedGridCell of bannedGridCells) {
      const [row, column] = [Math.floor(bannedGridCell / gridCellsInRow), bannedGridCell % gridCellsInRow];
